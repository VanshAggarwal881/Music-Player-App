const music = new Audio('artist_yoyo_songs/1.mp3');
// music.play();
...
const songs = [ 
    {
        ...
        poster: "honey_singh.webp"
    },

    {
        id : 2,
        songname : `Angrezi Beat
        <br>
        <div class="subtitle">Honey Singh</div>`,
        poster: "honey_singh.webp"
    },
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click' , (el) =>{
        index = el.target.id;
        poster_play_bar.src = `honey_singh.webp`;
        music.src = `artist_yoyo_songs/${index}.mp3`;
        music.play();
        masterplay.classList.remove('fa-play');
        masterplay.classList.add('fa-pause');
        download_music.href = `artist_yoyo_songs/${index}.mp3`;
