const music = new Audio('artist_arijit_songs/1.mp3');
// music.play();
...
const songs = [ 
    {
        ...
        poster: "artist_arijit_image/1.jpg"
    },

    {
        ...
        <br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "artist_arijit_image/2.jpg"
    },

    {
        ...
        <br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "artist_arijit_image/3.jpg"
    },

    {
        ...
        <br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "artist_arijit_image/4.jpg"
    },

    {
        ...
        <br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "artist_arijit_image/5.jpg"
    },

    {
        ...
        <br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "artist_arijit_image/6.jpg"
    },

    {
        ...
        <br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "artist_arijit_image/7.jpg"
    },

    {
        ...
        <br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "artist_arijit_image/8.jpg"
    }
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click' , (el) =>{
        index = el.target.id;
        poster_play_bar.src = `artist_arijit_image/${index}.jpg`;
        music.src = `artist_arijit_songs/${index}.mp3`;
        music.play();
        masterplay.classList.remove('fa-play');
        masterplay.classList.add('fa-pause');
        download_music.href = `artist_arijit_songs/${index}.mp3`;
